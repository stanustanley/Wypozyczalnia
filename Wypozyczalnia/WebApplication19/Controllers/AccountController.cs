...
namespace WebApplication19.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Roles_Listing()
        {
        ...
        public ActionResult Delete(string RoleName)
        {
            ...
            context.SaveChanges();
            return RedirectToAction("Roles_Listing");
        }

        // GET: /Roles/Edit/5
        public ActionResult Edit_Role(string roleName)
        {
            var context = new ApplicationDbContext();
            var thisRole = context.Roles.Where(r => r.Name.Equals(roleName, StringComparison.CurrentCultureIgnoreCase)).FirstOrDefault();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit_Role(Microsoft.AspNet.Identity.EntityFramework.IdentityRole role)
        {
            var context = new ApplicationDbContext();
            try
            {
        ...
        // POST: /Roles/Create
        [HttpPost]
        public ActionResult Create_Role(FormCollection collection)
        {
            var context = new ApplicationDbContext();
            try
            {
        ...
        //[Authorize(Users = "@mobilek.pl$")]
        [Authorize(Users = "prac0@mobilek.pl,prac1@mobilek.pl,prac2@mobilek.pl,prac3@mobilek.pl,prac4@mobilek.pl,prac5@mobilek.pl,prac6@mobilek.pl,prac7@mobilek.pl,prac8@mobilek.pl,prac9@mobilek.pl,prac10@mobilek.pl")]
        [HttpPost]
        [ValidateAntiForgeryToken] 
        public async Task<ActionResult> Register2(ViewModel.RegisterViewModel_prac model)
        {
            //if (ModelState.IsValid)
            {
                ...
                {
                    WebApplication19.Models.uzytkownicy uzytkownik = new Models.uzytkownicy();
                    uzytkownik.pracownik.Add(model.Pracownik);
                    uzytkownik.haslo = model.Password;
                    uzytkownik.nazwa_uzytkownika = model.Email;
                    uzytkownik.typ = "pracownik";
